# Construção de DW Simples

Extração utilizando Python e yfinance para extração de dados de Commodities.

Etapa de Transformação e Carga com Dbt.

App criada com Streamlit
